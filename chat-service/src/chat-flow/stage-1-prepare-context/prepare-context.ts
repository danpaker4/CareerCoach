...
import { DEFAULT_MODE_DETECTION_RESULT } from "./mode-detection/conversation-mode.consts";
import { modeForQuickHelpFlow } from "../stage-2-shortcuts/quick-help/shared/quick-help.utils";
...
export const runStage1PrepareContext = async (
    ...
    const stickyMode = modeForQuickHelpFlow(conversationAfterUserMessage.quickHelpFlow);

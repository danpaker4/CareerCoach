...
export const PROMPTFOO_VIEW_DEFAULT_URL = 'http://127.0.0.1:15500';
export const PROMPTFOO_RUNS_PATH = `${ENV.EVALUATION_SERVICE_BASE_URL}/promptfoo/runs`;
export const PROMPTFOO_RUN_STATUS_PATH = `${ENV.EVALUATION_SERVICE_BASE_URL}/promptfoo/runs/current`;
...
export const MANAGEMENT_PROMPTFOO_RUN_ERROR_MESSAGE = 'Unable to start Promptfoo evaluation';
export const MANAGEMENT_PROMPTFOO_STATUS_ERROR_MESSAGE = 'Unable to load Promptfoo run status';
